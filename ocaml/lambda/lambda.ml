...
let layout_boxed_vector : Primitive.boxed_vector -> layout = function
  | Pvec128 Int8x16 -> non_null_value (Pboxedvectorval (Pvec128 Int8x16))
  | Pvec128 Int16x8 -> non_null_value (Pboxedvectorval (Pvec128 Int16x8))
  | Pvec128 Int32x4 -> non_null_value (Pboxedvectorval (Pvec128 Int32x4))
  | Pvec128 Int64x2 -> non_null_value (Pboxedvectorval (Pvec128 Int64x2))
  | Pvec128 Float32x4 -> non_null_value (Pboxedvectorval (Pvec128 Float32x4))
  | Pvec128 Float64x2 -> non_null_value (Pboxedvectorval (Pvec128 Float64x2))
