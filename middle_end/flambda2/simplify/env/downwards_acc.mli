...
val get_and_clear_lifted_continuations : t -> t * (Downwards_env.t * Lifted_cont.original_handlers) list

val add_lifted_continuation : Downwards_env.t -> Lifted_cont.original_handlers -> t -> t
