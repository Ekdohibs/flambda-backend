...
let compute_extra_params_in_unspecified_order ({ decisions; rewrite_ids_seen = _; } : Decisions.t) =
  List.fold_left (fun extra_params (_, decision) ->
      Unboxing_epa.compute_extra_params_in_unspecified_order extra_params decision
